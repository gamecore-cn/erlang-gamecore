...
%%
%% @spec make_int_list(Binary::binary(), IntArray::list(), BinaryIndex::integer(), IntListIndex::integer()) -> list()
...
encrypt(Data, Key) when (is_list(Data) orelse  is_binary(Data)) and is_list(Key) ->
